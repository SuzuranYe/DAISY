r"""Script_DAISY_Lib_Database_Parse：档案数据解析与旧报告写入器。
...
用法：
  python .\Script\Script_DAISY_CLI.py export-report --snapshot .\Output\Snapshots\Scan_x.sqlite
  python .\Script\Script_DAISY_CLI.py export-report --diff .\Output\Diffs\Diff_x.sqlite
"""
