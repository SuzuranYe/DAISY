...
哈希／格式核验的兼容行为仍由 ``Script_DAISY_Lib_Snapshot_Verify`` 提供；
...
import Script_DAISY_Lib_Snapshot_Verify as legacy
import Script_DAISY_Lib_Verify_Tools as verifytools
