...
import Script_DAISY_Lib_DBS_03_Hash as hash_stage
...
_CONTRACT_PATH = os.path.join(
    _TEST_DIR, "Fixtures", "DBS_v1_4_1_Schema3_Contract.json")
_DIFF_MODULE = os.path.join(
    _SCRIPT_DIR, "Module", "Script_DAISY_Module_DBS_21_Diff.py")
